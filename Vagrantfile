...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "ubuntu" do |ubuntu|
    ...
    ubuntu.vm.hostname = "test1"
    ubuntu.vm.provision :shell, path: "bootstrap.sh"
    ubuntu.vm.network :forwarded_port, guest: 80, host: 4567
    ubuntu.vm.network :private_network, ip: "192.168.33.40"
  end
  
  config.vm.define "centos" do |centos|
    centos.vm.box = "nrel/CentOS-6.5-x86_64"
    centos.vm.hostname = "test2"
    centos.vm.network :forwarded_port, guest: 80, host: 5678
